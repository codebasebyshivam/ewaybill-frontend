...
const Hero = ({ isLoaded }) => {
  ...
  return (
    <section className={`text-center mb-20 transform transition-all duration-1000 delay-300 ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
      ...
      <div className="flex justify-center items-center space-x-6">
        <button onClick={handleNavigateToLogin} className="group relative bg-action-button-gradient text-white px-10 py-4 rounded-full font-bold text-lg overflow-hidden transform transition-all duration-300 hover:scale-105 hover:shadow-2xl">
