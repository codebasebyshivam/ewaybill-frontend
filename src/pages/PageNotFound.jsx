    ...
    <div className="min-h-screen bg-white flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        <div className="mb-12 relative inline-block">
          ...
          <div className="absolute -top-6 -left-6 w-12 h-12 bg-gradient-to-br from-blue-400 to-blue-500 rounded-lg transform rotate-12 animate-pulse opacity-80"></div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <ActionButton icon={Home} label="Back to Home" variant="primary" />
          <ActionButton icon={Search} label="Search" variant="secondary" />
          <ActionButton icon={ArrowLeft} label="Go Back" variant="secondary" />
        </div>
