...
const FlipCard = () => {
  ...
  return (
    <div className="w-[300px] h-[400px] perspective">
      <div
        className={` relative w-full h-full transition-transform duration-700 transform-style  ${flipped ? 'rotate-y-180' : ''}`}
      >
        {/* Front */}
        <div className="bg-red-500 absolute w-full h-full backface-hidden  text-black rounded-xl shadow-lg p-6">
          <h2 className="text-center  text-white font-nunito text-xl font-semibold mb-4">
            DL1LQ5147
          </h2>
        ...
        <div className="bg-green-500 absolute w-full h-full backface-hidden rotate-y-180  text-white rounded-xl shadow-lg p-6">
          ...
          <ul className="text-sm space-y-3">
            <li>
              <span className="text-gray-400">Engine:</span> G12BN1200139
            </li>
            <li>
              <span className="text-gray-400">Chassis:</span> MA3EZLF1T00272610
            </li>
            <li>
              <span className="text-gray-400">Body Type:</span> Open Body
            </li>
            <li>
              <span className="text-gray-400">Unladen Weight:</span> 875
            </li>
            <li>
              <span className="text-gray-400">Present Address</span> 487/182
              Peeragarhi National Market School Road
            </li>
            <li>
              <span className="text-gray-400">Cylinders:</span> 2
            </li>
            <li>
              <span className="text-gray-400">Seating Capacity:</span> 2
            </li>
            <li className="truncate  max-w-[300px]">
              <span className="text-gray-400">Son/Wife/Daughter of:</span> Open
              Body
            </li>
          </ul>
